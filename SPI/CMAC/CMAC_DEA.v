...
localparam S5 = 3'b101; // AUTHENTICATED
...
always @(posedge clk or posedge rst) begin
    if (rst) begin
        ...
        // S1 - Send AUTH_INIT and receive bytes
        ...
        // get 16 byte rec_IC_enc through RX_BUFFER
