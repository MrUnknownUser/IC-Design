...
localparam S2 = 3'b010; // DEC_CHALLENGE 
localparam S3 = 3'b011; // GEN_CHALLENGE STORE_EPH_KEY 
localparam S4 = 3'b100; // REQUEST_AUTH
localparam S5 = 3'b101; // KEYCARD_AUTHENTICATION
localparam S6 = 3'b110; // VALIDATE_ID
